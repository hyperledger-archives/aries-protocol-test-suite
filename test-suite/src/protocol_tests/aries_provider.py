...
class AriesProvider(ABC):
    """Abstract class for an Aries provider."""
    ...
    async def setup(self, config: dict) -> None:
        ...
        Parameters:
        config (dict): Provider-specific configuration information.
    ...
    async def issuer_create_credential_schema(self, name: str, version: str, attr_names: [str]) -> str:
        """
    ...
    async def issuer_create_credential_definition(self, schema_id: str) -> str:
        """
    ...
    async def issuer_create_credential(self, offer_passback: any, request_b64_attach: str, attrs: dict) -> str:
        """
        Create a credential.
    ...
    async def holder_create_credential_request(self, b64_offer_attach: str) -> (str, any):
        """
    ...
    async def holder_store_credential(self, b64_credential_attach: str, store_credential_passback: dict) -> None:
        """
        Store a credential.
